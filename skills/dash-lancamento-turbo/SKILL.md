...
Se `CLAUDE_API_KEY` estiver configurada, Worker chama Claude com os agregados do dia e devolve 3 bullets em tom Leo Tabari (lido de `workspace/lancamentos/{slug}/00-fundacao/voz.md`).
...
- `@pesquisador-turbo` — fornece `workspace/lancamentos/{slug}/00-fundacao/voz.md` para `/insights` narrar no tom do expert
