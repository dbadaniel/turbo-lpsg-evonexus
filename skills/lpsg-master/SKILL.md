...
[Cadastro validado]
       ↓
1. @pesquisador-turbo            → 6 dossiês internos (workspace/lancamentos/{slug}/00-fundacao/)
       ↓
2. @pesquisador-mercado-turbo    → 8 frentes externas (workspace/lancamentos/{slug}/02-mercado/)
       ↓
...
Construa os 6 dossiês fundacionais em workspace/lancamentos/{slug}/00-fundacao/:
...
Gere relatórios em workspace/lancamentos/{slug}/02-mercado/ cobrindo as 8 frentes:
...
📁 workspace/lancamentos/{slug}/00-fundacao/ gerado:
   • voz.md
   • avatar.md
   • oferta.md
   • briefing.md
...
📁 workspace/lancamentos/{slug}/02-mercado/ gerado:
...
1. Valida pré-requisitos (`workspace/lancamentos/{slug}/00-fundacao/` 6 arquivos · `workspace/lancamentos/{slug}/02-mercado/` 8 relatórios)
...
4. Salva em `workspace/lancamentos/{slug}/03-revisoes/Briefing-Aprovacao-{SIGLA}-{DDMMYY}.docx`
...
📁 Local:    workspace/lancamentos/{slug}/03-revisoes/Briefing-Aprovacao-{SIGLA}-{DDMMYY}.docx
...
> Se o expert pedir ajustes (opção 2): aplique mudanças em `workspace/lancamentos/{slug}/00-fundacao/` ou `workspace/lancamentos/{slug}/02-mercado/` · regenere briefing com `briefing-aprovacao-turbo` · sobe `v2` no Drive · espera nova aprovação.
...
> **Cada fase referencia `workspace/lancamentos/{slug}/00-fundacao/` e `workspace/lancamentos/{slug}/02-mercado/`** gerados no Passo 2.
...
2. **`@copywriter-turbo`** lê `workspace/lancamentos/{slug}/00-fundacao/` antes de escrever (referência ao output do pesquisador)
