...
TRIGGER: usuário pede "executar LPSG" / "crie meu LPSG" / "começar projeto"
   │
   ├── 1. @pesquisador-turbo       → extrai 6 dossiês internos (workspace/lancamentos/{slug}/00-fundacao/)
   │                                  voz · avatar · oferta · briefing · referências · inventário
   │
   ├── 2. @pesquisador-mercado-turbo → extrai 8 frentes externas (workspace/lancamentos/{slug}/02-mercado/)
   ...
   └── 4. ⏸️ PAUSA · aguarda aprovação do expert no Google Docs/Word
          ...
          Operador avisa "briefing aprovado · pode seguir"
                                       │
                                       ▼
                  SÓ AGORA começa Fase 1 (estrutura-aulas-lpsg)
```
...
Status atual:
- [ ] workspace/lancamentos/{slug}/00-fundacao/ · @pesquisador-turbo rodou?
- [ ] workspace/lancamentos/{slug}/02-mercado/ · @pesquisador-mercado-turbo rodou?
- [ ] Briefing .docx gerado e subido no Drive?
- [ ] Expert assinou aprovação?

Volta pro @estrategista-turbo (ou lpsg-master) pra rodar o gate inicial.
Depois eu executo [a fase X] com o contexto certo."
```

### Por que esse gate existe (justificativa pra recusar pressão por atalho)

- Sem fundação interna (`workspace/lancamentos/{slug}/00-fundacao/`) → copy genérica, não soa o expert
- Sem fundação externa (`workspace/lancamentos/{slug}/02-mercado/`) → posicionamento clonado, sem diferenciação
